...
static const char *fonts[]          = {  "JetBrainsMonoNerdFont-Medium.ttf=15" };
static const char dmenufont[]       = "JetBrainsMonoNerdFont-Medium.ttf:size=13";
...
static const char col_purple2[]     = "#a63ac7";
